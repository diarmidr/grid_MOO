...
"""These are mostly annualised CAPEX calculated from levelised costs and capacity factors. E.g. OCGT from BEIS 2025 predicted
 ...
 LCOE reported by Ricardo directly, as capacity factor is always 1. Hence CAPEX is set to 0.
  Offshore wind value is based on recent UK CfD of 2023£72/MWh and cap factor of 0.3"
 Offshore wind value is based on recent Irish auction of 2023£73/MWh and cap factor of 0.4"""
CAPEX_dict = {"Onshore_wind": [190, 0],
              "Offshore_wind": [250, 0],
              "PV": [57, 0],
              "Nuclear": [890, 0],
              "BECCS": [0, 0],
...
# RTE first"""
ESS_dict_full = [["LIB_type", 0.85, 0.5],
            ["PHS_type", 0.75, 0.5],
            ["CAES_type", 0.5, 0.5],
            ["HES_type", 0.35, 0.5]]
ESS_dict_UKES_2024 = [["HES_type", 0.53, 0.5]]
